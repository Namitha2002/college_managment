...
def marksheet():
       ...
       Label_School = Label(Frame_1, text = 'Department', font = ('arial',15,'bold'), bg = 'Navajo white')
       ...
       Label_Subject.grid(row = 0, column = 0, padx = 50, pady = 10)

       Label_obt_Marks = Label(Frame_2, text = 'MARKS OBTAINED', font = ('arial',16,'bold'), bg = 'Navajo white')
       Label_obt_Marks.grid(row = 0, column = 1, padx = 20)

       Label_Subject = Label(Frame_2, text = 'PASSING MARKS', font = ('arial',16,'bold'), bg = 'Navajo white')
       Label_Subject.grid(row = 0, column = 2, padx = 20)

       Label_obt_Marks = Label(Frame_2, text = 'TOTAL MARKS', font = ('arial',16,'bold'), bg = 'Navajo white')
       Label_obt_Marks.grid(row = 0, column = 3, padx = 20)

       Label_1 = Label(Frame_2, text = 'SUBJECT 1', font = ('arial',14), bg = 'Navajo white')
       Label_1.grid(row = 1, column = 0)
       Label_2 = Label(Frame_2, text = 'SUBJECT 2', font = ('arial',14), bg = 'Navajo white')
       Label_2.grid(row = 2, column = 0)
       Label_3 = Label(Frame_2, text = 'SUBJECT 3', font = ('arial',14), bg = 'Navajo white')
       Label_3.grid(row = 3, column = 0)
       Label_4 = Label(Frame_2, text = 'SUBJECT 4', font = ('arial',14), bg = 'Navajo white')
       Label_4.grid(row = 4, column = 0)
       Label_5 = Label(Frame_2, text = 'SUBJECT 5', font = ('arial',14), bg = 'Navajo white')
