...
class Fee():
    def __init__(self, master):
        ...
        Title_Frame = LabelFrame(
            Main_Frame, width=100, height=100, bg='Navajo white', relief='ridge', bd=15)
        ...
        # ==================================================Buttons=================================================
        btnSave = Button(Button_Frame, text='SAVE', font=('arial', 14, 'bold'), width=10, command=Insert)
        ...
        btnReceipt.grid(row=0, column=2, padx=5, pady=5)
